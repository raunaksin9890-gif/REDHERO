...
urlpatterns = [
    ...
    path("global-search/", views.global_search),
    ...
    path("attendance/pdf/", views.attendance_pdf),
    ...
    path("fees/payments/", admin_api.fee_payments),
    ...
    path("exams/question-template/", admin_api.exam_question_template),
    path("exams/<str:exam_id>/questions/", admin_api.exam_questions),
    path("exams/<str:exam_id>/questions/bulk-import/", admin_api.exam_questions_bulk_import),
    path("exams/<str:exam_id>/duplicate/", admin_api.exam_duplicate),
    ...
    path("exam-attempts/<str:attempt_id>/result-pdf/", admin_api.exam_attempt_result_pdf),
